...
python plot.py custom/sort_results.csv "Custom Sort"
python plot.py custom/scan_results.csv "Custom Scan"
python plot.py custom/focus_results.csv "Custom Focus"
